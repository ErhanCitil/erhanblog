...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "erhanblog.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "erhanblog.wsgi.application"
...
DEFAULT_FROM_EMAIL = "erhanblog@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "erhanblog.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "erhanblog.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "erhanblog_sessionid"
...
CSRF_FAILURE_VIEW = "erhanblog.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "erhanblog.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"erhanblog {ENVIRONMENT}",
