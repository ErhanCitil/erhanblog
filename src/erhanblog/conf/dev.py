...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-q9)_r2s$c2#_7z4dx0)k#=m!r5wf%i&_(zp34v)!b&kqk12+5i",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "erhanblog"),
os.environ.setdefault("DB_USER", "erhanblog"),
os.environ.setdefault("DB_PASSWORD", "erhanblog"),
