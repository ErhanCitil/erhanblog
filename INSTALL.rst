...
``src/erhanblog/conf/local.py``. You can base this file on the
...
.. _Github: https://github.com/maykinmedia/erhanblog/
...
environment variables. See ``src/erhanblog/conf/docker.py`` for
all settings.
