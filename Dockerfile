...
COPY --from=frontend-build /app/src/erhanblog/static /app/src/erhanblog/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=erhanblog.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://bitbucket.org/maykinmedia/erhanblog" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="erhanblog"
